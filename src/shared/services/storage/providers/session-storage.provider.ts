...
export class SessionStorageProvider implements StorageProvider {
  ...
  async setItem(key: string, value: string): Promise<void> {
    try {
      ...
      throw new StorageError(`Failed to set item: ${error}`, 'SET_FAILED', 'sessionStorage')
    }
  }
  ...
  async getItem(key: string): Promise<string | null> {
    try {
      ...
      throw new StorageError(`Failed to get item: ${error}`, 'GET_FAILED', 'sessionStorage')
    }
  }
  ...
  async removeItem(key: string): Promise<void> {
    try {
      ...
      throw new StorageError(`Failed to remove item: ${error}`, 'REMOVE_FAILED', 'sessionStorage')
    }
  }
  ...
  async clear(): Promise<void> {
    try {
      ...
      throw new StorageError(`Failed to clear storage: ${error}`, 'CLEAR_FAILED', 'sessionStorage')
    }
  }
  ...
  async keys(): Promise<string[]> {
    try {
      ...
      throw new StorageError(`Failed to get keys: ${error}`, 'KEYS_FAILED', 'sessionStorage')
    }
  }
  ...
  async getUsage(): Promise<StorageUsage> {
    try {
      ...
      throw new StorageError(`Failed to get usage: ${error}`, 'USAGE_FAILED', 'sessionStorage')
    }
  }
