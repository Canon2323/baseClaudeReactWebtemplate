...
export class LocalStorageProvider implements StorageProvider {
  ...
  async setItem(key: string, value: string): Promise<void> {
    try {
      ...
      throw new StorageError(`Failed to set item: ${error}`, 'SET_FAILED', 'localStorage')
    }
  }
  ...
  async getItem(key: string): Promise<string | null> {
    try {
      ...
      throw new StorageError(`Failed to get item: ${error}`, 'GET_FAILED', 'localStorage')
    }
  }
  ...
  async removeItem(key: string): Promise<void> {
    try {
      ...
      throw new StorageError(`Failed to remove item: ${error}`, 'REMOVE_FAILED', 'localStorage')
    }
  }
  ...
  async clear(): Promise<void> {
    try {
      ...
      throw new StorageError(`Failed to clear storage: ${error}`, 'CLEAR_FAILED', 'localStorage')
    }
  }
  ...
  async keys(): Promise<string[]> {
    try {
      ...
      throw new StorageError(`Failed to get keys: ${error}`, 'KEYS_FAILED', 'localStorage')
    }
  }
  ...
  async getUsage(): Promise<StorageUsage> {
    try {
      ...
      throw new StorageError(`Failed to get usage: ${error}`, 'USAGE_FAILED', 'localStorage')
    }
  }
