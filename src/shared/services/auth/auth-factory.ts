import type { IAuthProvider, AuthProviderType, AuthProviderConfig } from '@/shared/types/auth'

// Factory para criação de providers (Factory Pattern + Strategy Pattern)
export class AuthProviderFactory {
  private static providers: Map<AuthProviderType, () => Promise<IAuthProvider>> = new Map()
  ...
  static async createProvider(config: AuthProviderConfig): Promise<IAuthProvider> {
