...
async function main() {
  ...
  log(
    "This will set up everything for your Next.js SOLID Boilerplate:",
    "blue",
  );
  ...
  try {
    ...
    try {
      ...
      if (platform === "win32") {
        ...
        try {
          ...
          // Fallback to npm
          execSync("npm install -g @githubnext/github-copilot-cli", {
            stdio: "inherit",
          });
        }
    ...
    warning(
      "GitHub CLI setup had some issues - you can install manually from https://cli.github.com/",
    );
  }
...
`;
  ...
  log("\n🚀 READY TO USE:", "bold");
  log(
    "Everything is configured automatically - no manual steps needed!",
    "green",
  );
